...
export class ApiService {
  ...
  // Fetching all the products category
  getProductsCategory(): Observable<any> {
    return this.http.get<any>(environment.baseUrl+environment.productCategoryUrl);
  }

  // Search all the products
  getProductsByName(productname): Observable<any> {
    return this.http.get<any>(environment.baseUrl+environment.productsSearchUrl+ "?productname=" + productname);
  }

  // Add product in the system
  addProduct( desc: string,
    quan: string, price: string, prodname: string, image: File, prodcat: string): Observable<any> {
  ...
  // fetch available orders placed
  getOrdersByUser() {
    return this.http.get<any>(environment.baseUrl+environment.viewOrderByUserUrl)
  }
